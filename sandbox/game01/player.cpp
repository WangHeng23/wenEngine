...
player::player() {
    ...
    m_SmokeParticle.SizeBegin = 0.35f, m_SmokeParticle.SizeEnd = 0.0f,
    ...
    m_EngineParticle.VelocityVariation = {3.0f, 2.0f};
    m_EngineParticle.SizeBegin = 0.5f, m_EngineParticle.SizeEnd = 0.0f,
    m_EngineParticle.SizeVariation = 0.3f;
    m_EngineParticle.ColorBegin = {254.f / 255.0f, 109 / 255.0f, 41 / 255.0f,
                                   1.0f};
...
void player::loadAssets() {
    m_ShipTexture = texture2D::create("sandbox/assets/textures/Ship.png");
}

void player::OnUpdate(wen::timeStep ts) {
    m_Time += ts;
    if (input::IsKeyPressed(WEN_KEY_SPACE)) {
        ...
        m_EngineParticle.Position =
            m_Position + glm::vec2{rotated.x, rotated.y};
